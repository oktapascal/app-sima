<div class="flex justify-center items-center content-center flex-col mt-24">
    <div aria-label="Loading..." role="status">
        <svg class="h-12 w-12 animate-spin stroke-gray-500 dark:stroke-white" viewBox="0 0 256 256">
    ...
    <div>
        <h4 class="text-xl font-bold text-gray-500 dark:text-white">Loading Page...</h4>
    </div>
</div>